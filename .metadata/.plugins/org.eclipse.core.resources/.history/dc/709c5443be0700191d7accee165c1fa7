...
public class PA13DShelar extends JFrame implements Runnable
{
	...
	public static void main(String [] args)
	{
		...
		if (args != null && args.length >= 1)
			...
			delay = 100;
		PA13DShelar win = new PA13DShelar(delay);
		...
		public void actionPerformed(ActionEvent e)
		{
			if (e.getSource() == runDemo)
			{
				if (!paused)
				{
					...
					runThread = new Thread(PA13DShelar.this);
					runThread.start();
				}
				else
				{
